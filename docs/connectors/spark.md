...
=== "Gradle"
    ...
    ```kotlin
    dependencies {
        implementation("io.gvdb:gvdb-spark-connector_2.13:0.32.1") // x-release-please-version
    }
    ```
...
=== "Maven"
    ...
    <dependency>
      ...
      <version>0.32.1</version> <!-- x-release-please-version -->
    </dependency>
    ```
...
=== "spark-submit"
    ...
    ```bash
    spark-submit --packages io.gvdb:gvdb-spark-connector_2.13:0.32.1 my_job.py # x-release-please-version
    ```

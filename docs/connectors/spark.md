...
=== "Gradle"
    ...
    ```kotlin
    dependencies {
        implementation("io.gvdb:gvdb-spark-connector_2.13:0.28.0") // x-release-please-version
    }
    ```
...
=== "Maven"
    ...
    <dependency>
      ...
      <version>0.28.0</version> <!-- x-release-please-version -->
    </dependency>
    ```
...
=== "spark-submit"
    ...
    ```bash
    spark-submit --packages io.gvdb:gvdb-spark-connector_2.13:0.28.0 my_job.py # x-release-please-version
    ```
